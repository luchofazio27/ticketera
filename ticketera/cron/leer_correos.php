...
if (stripos($comentario, '[heart]') !== false) {

    $reaccion = "Corazón";

    $comentario =
        "[SISTEMA][REACCION][CORAZON] " .
        $nombreUsuario .
        " reaccionó con 'Corazón' al comentario.";

}
elseif (stripos($comentario, '[like]') !== false) {

    $reaccion = "Me gusta";

    $comentario =
        "[SISTEMA][REACCION][LIKE] " .
        $nombreUsuario .
        " reaccionó con 'Me gusta' al comentario.";
...
elseif (stripos($comentario, '[celebrate]') !== false) {
    ...
    $comentario =
        "[SISTEMA][REACCION][CELEBRACION] " .
        $nombreUsuario .
        " reaccionó con 'Celebración' al comentario.";
...
elseif (stripos($comentario, '[laugh]') !== false) {
    ...
    $comentario =
        "[SISTEMA][REACCION][RISA] " .
        $nombreUsuario .
        " reaccionó con 'Risa' al comentario.";
...
elseif (stripos($comentario, '[surprised]') !== false) {
    ...
    $comentario =
        "[SISTEMA][REACCION][SORPRESA] " .
        $nombreUsuario .
        " reaccionó con 'Sorpresa' al comentario.";
...
elseif (stripos($comentario, '[sad]') !== false) {
    ...
    $comentario =
        "[SISTEMA][REACCION][TRISTE] " .
        $nombreUsuario .
        " reaccionó con 'Triste' al comentario.";
...
// ========================================
// DEBUG INDICADORES DE LECTURA
// ========================================

$estadoLectura = $ticket->obtener_estado_lectura($ticket_id);

echo "<pre>";
echo "ESTADO LECTURA TICKET {$ticket_id}:\n";
print_r($estadoLectura);
echo "</pre>";
