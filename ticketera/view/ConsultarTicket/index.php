...
En esta página puedes consultar el estado y el progreso de tus tickets actualmente abiertos.<br>
<b>IMPORTANTE:</b> Haciendo clic en el icono <b>"ojo"</b> podrás acceder al detalle del ticket.
</p>
                </header>
                ...
                <div class="box-typical box-typical-padding">
                    ...
                    <div class="row" id="viewuser">
                        <div class="col-lg-2 col-md-2 col-sm-6" style="display: none;">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6">
                            <fieldset class="form-group">
                                <label class="form-label">&nbsp;</label>
                                <button type="submit" class="btn btn-rounded btn-primary btn-block" id="btnmistickets">Mis Tickets Asignados</button>
                            </fieldset>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6">
                            <fieldset class="form-group">
                                <label class="form-label">&nbsp;</label>
                                <button type="submit" id="btnTicketsCreados" class="btn btn-rounded btn-primary btn-block">Mis Tickets Creados</button>
                            </fieldset>
                        </div>
                    </div>
                        ...
                        <table id="ticket_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        class="d-none d-sm-table-cell <?php echo ($rol_id == 5 || $rol_id == 2) ? 'col-asignar' : ''; ?>"
                                        style="width: 7%;">
                                        <?php
